...
const ShipmentDetails: React.FC = () => {
  ...
  useEffect(() => {
    if (id) {
      fetchShipmentDetails(parseInt(id));
    }
  }, [id]);
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Created on {new Date(shipment.created_at).toLocaleDateString()}</p>
            </div>
          </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h4 className="text-sm font-medium text-gray-600 mb-3">Sender</h4>
              ...
              <div>
                <h4 className="text-sm font-medium text-gray-600 mb-3">Receiver</h4>
                <div className="space-y-2">
                  <div className="flex items-center text-sm">
                    <UserIcon className="h-4 w-4 text-gray-400 mr-2" />
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900">{new Date(shipment.updated_at).toLocaleDateString()}</p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100 sticky top-6">
            ...
            {history.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-600">No tracking history yet</p>
              </div>
            ) : (
